...
if(isset($_POST['supp'])) {
    ...
    $query = "DELETE FROM pages_gestion_ressources_agent WHERE pages_gestion_ressources_agent.id ='$id' ";
    $result = $connexion->query($query);

    // Vérifiez si la suppression a réussi
    if ($result) {
        // Redirigez l'utilisateur vers une page de confirmation ou une autre page appropriée
        header("Location: pages-tache-ressources-agent.php");
        exit();
    } else {
...
<head>
  ...
  <title>Pages / tache - Niceressources-agent Bootstrap Template</title>
  ...
  <!-- =======================================================
  * Template Name: Niceressources-agent
  * Updated: Sep 18 2023 with Bootstrap v5.3.2
  * Template URL: https://bootstrapmade.com/nice-ressources-agent-bootstrap-ressources-agent-php-template/
...
<body>
  ...
  <aside id="sidebar" class="sidebar" data-aos="fade-right" data-aos-delay="300" data-aos-duration="400">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="users-profile-ressources-agent.php">
          <i class="bi bi-person"></i>
          <span>Profil</span>
        </a>
      </li><!-- End Profile Page Nav -->
      <li class="nav-item">
        <a class="nav-link " href="pages-gestion-ressources-agent.php">
  ...
  <main id="main" class="main"  data-aos-duration="600" data-aos="fade-left" data-aos-delay="500">
    ...
    <section class="tache-rapport">
        ...
        <table class="table" style="width: max-content; margin: 0 auto; " >
                <h2>Contrats</h2>
                <button class="add-button" onclick="openModal('task')" style="width:200px; height:100px ;">AJOUTER UN CONTRAT</button><br><br>
    ...
    <table class="table" style="width: max-content; box-shadow:1px 1px 10px black; position:absolute;  top:500px">
        <thead>
            <tr>
                ...
                <th style="color: red;">TYPE DE CONTRAT</th>
                <th style="color: red;">DATE DEBUT</th>
                <th style="color: red;">DATE FIN</th>
                <th style="color: red;">SALAIRE</th>
        ...
        <tbody>
            <?php
                ...
                $envoi = "SELECT * FROM pages_gestion_ressources_agent";
    ...
    <div class="modal" id="modal">
        <div class="modal-content">
            ...
            <form id="task-form" method="POST" style="display: none;">
                    ...
                    <label for="nom" style="color:red"><strong>NOM DE L'EMPLOYE</strong></label>
                        ...
                        <option value="" disabled selected hidden>Sélectionnez le nom de l'employé svp...</option>
                            <?php 
                                ...
                                $sql = "SELECT nom FROM agent UNION SELECT nom FROM respo UNION SELECT nom FROM technicien";
                                $result = $connexion->query($sql);
                    ...
                    <label for="nom" style="color:red"><strong>PRENOM DE L'EMPLOYE</strong></label>
                        ...
                        <option value="" disabled selected hidden>Sélectionnez le prenom de l'employé svp...</option>
                            <?php 
                                ...
                                // SQL query to select names from the combined tables
                                $sql = "SELECT prenom FROM agent UNION SELECT prenom FROM respo UNION SELECT prenom FROM technicien";
                                $result = $connexion->query($sql);
                ...
                <div>
                    <label for="type_contrat" style="color:red"><strong>TYPE DE CONTRAT</strong></label>
                    <select name="type" id="" class="form-control" >
                        <option value="" disabled selected hidden>Sélectionnez le type contrat svp...</option>
                        <option value="" name="cdi">Contrat à Durée Indéterminée (CDI)</option>
                        <option value="" name="cdi">Contrat à Durée Déterminée (CDD)</option>
                        <option value="" name="cdi">Contrat de Travail Temporaire(CTT)</option>
                        <option value="" name="cdi">Contrat d’Apprentissage (CA)</option>
                        <option value="" name="cdi">Contrat de stage (CS)</option>
                        <option value="" name="cdi">Contrat de Travail à Temps Partiel (CTTP)</option>
                    </select>
                </div>
                <div>
                ...
                <div>
                    <label for="salaire" style="color:red"><strong>SALAIRE EN FCFA</strong></label>
                    <input type="salaire" id="salaire" name="salaire" class="form-control" required>
                </div>
                <div>
...
<script>
  ...
  <footer id="footer" class="footer justify-content-center" style="position:relative;  top:2000px; display:flex; align-items:center;">
    ...
    <div class="credits">
      ...
      <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/nice-ressources-agent-bootstrap-ressources-agent-php-template/ -->
