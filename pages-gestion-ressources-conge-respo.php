...
if(isset($_POST['supp'])) {
    ...
    $query = "DELETE FROM pages_gestion_ressources_conge_respo WHERE pages_gestion_ressources_conge_respo.id ='$id' ";
...
<body>
  ...
  <aside id="sidebar" class="sidebar" data-aos="fade-right" data-aos-delay="300" data-aos-duration="400">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="pages-gestion-ressources-absences-respo.php">
      ...
      <li class="nav-item">
        <a class="nav-link " href="pages-gestion-ressources-conge-respo.php">
    ...
    <table class="table" style="width: max-content; box-shadow:1px 1px 10px black; position:absolute;  top:500px">
        ...
        <tbody>
            <?php
                ...
                $envoi = "SELECT * FROM pages_gestion_ressources_conge_respo";
