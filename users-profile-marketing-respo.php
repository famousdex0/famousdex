...
if(isset($_POST['OKK'])) {
    ...
    $requete = $connexion->prepare("INSERT INTO info_marketing_respo (image, nom, bibliographie, compagnie, travail, pays, adresse, contact, email, twitter, facebook, instagram, linkedin) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    header('Location: users-profile-marketing-respo.php');
...
<head>
  ...
  <title>Users / Profile - Nicemarketing-respo Bootstrap Template</title>
  ...
  <!-- =======================================================
  * Template Name: Nicemarketing-respo
  * Updated: Sep 18 2023 with Bootstrap v5.3.2
  * Template URL: https://bootstrapmade.com/nice-marketing-respo-bootstrap-marketing-respo-php-template/
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index-marketing-respo.php" class="logo d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        ...
        ?>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="users-profile-marketing-respo.php">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="pages-faq-marketing-respo.php">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="index-marketing-respo.php">
  ...
  <!-- End Tables Nav -->
   ...
   <!-- End Charts Nav -->
    ...
    <!-- End Icons Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link " href="users-profile-marketing-respo.php">
          <i class="bi bi-person"></i>
          <span>Profil</span>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="pages-gestion-marketing-respo.php">
...
<li class="nav-item">
  <a class="nav-link collapsed" href="pages-tache-marketing-respo.php">
    ...
    <span>Tâches & Rapports</span>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="pages-contact-marketing-respo.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index-marketing-respo.php">Accueil</a></li>
    ...
    <section class="section profile">
      <div class="row">
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <?php
                        ...
                        $result = $connexion->query("SELECT image FROM info_marketing_respo "); // Remplacez 'table_images' et 'id' par vos valeurs réelles
        ...
        if (isset($_SESSION['email'])) {
            // Utilisateur connecté, afficher le nom et le prénom
            $email = $_SESSION['email'];
            $sql = "SELECT fonction FROM respo WHERE email = '$email'";
            $result = $connexion->query($sql);
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">
                    <?php $connexion = new mysqli("localhost", "root", "", "entreprise");
                      ...
                      $result = $connexion -> query("SELECT * FROM info_marketing_respo");
                             if ($result->num_rows > 0) {
                                       $row = $result->fetch_assoc(); 
                  ...
                  <div class="row">
                    ...
                    $connexion = new mysqli("localhost", "root", "", "entreprise");
                      ...
                      $resulta = $connexion -> query("SELECT compagnie FROM info_marketing_respo");
                  ...
                  <div class="row">
                    ...
                    $connexion = new mysqli("localhost", "root", "", "entreprise");
                      ...
                      $result = $connexion -> query("SELECT travail FROM info_marketing_respo ");
                             if ($result->num_rows > 0) {
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php 
                     $result = $connexion -> query("SELECT pays FROM info_marketing_respo ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["pays"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php
                     $result = $connexion -> query("SELECT adresse FROM info_marketing_respo ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["adresse"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php
                     $result = $connexion -> query("SELECT contact FROM info_marketing_respo ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["contact"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php 
                     $result = $connexion -> query("SELECT email FROM info_marketing_respo ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["email"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php
                     $result = $connexion -> query("SELECT twitter FROM info_marketing_respo ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["twitter"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php 
                     $result = $connexion -> query("SELECT facebook FROM info_marketing_respo ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["facebook"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php 
                     $result = $connexion -> query("SELECT instagram FROM info_marketing_respo ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["instagram"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php 
                     $result = $connexion -> query("SELECT linkedin FROM info_marketing_respo ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["linkedin"] ;
                                      }}  ?></div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/nice-marketing-respo-bootstrap-marketing-respo-php-template/ -->
