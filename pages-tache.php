...
if(isset($_POST['supp'])) {
    ...
    $query = "DELETE FROM tache_technicien WHERE tache_technicien.id ='$id' ";
    $result = $connexion->query($query);

    // Vérifiez si la suppression a réussi
    if ($result) {
        // Redirigez l'utilisateur vers une page de confirmation ou une autre page appropriée
        header("Location: pages-tache.php");
        exit();
    } else {
...
<head>
  ...
  <title>Pages / tache - NiceAdmin Bootstrap Template</title>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="users-profile.php">
          ...
          <span>Profil</span>
            ...
            <li class="nav-item">
            <a class="nav-link " href="pages-tache.php">
    ...
    <table class="table" style="width: max-content; box-shadow:1px 1px 10px black; position:absolute;  top:500px">
        ...
        <tbody>
            <?php
                ...
                $envoi = "SELECT * FROM tache_technicien";
                         ...
                         $result = $connexion->query($sql);
                          if ($result->num_rows > 0) {
                            ...
                            $nom =$_POST["Titre"];
                                                    ...
                                                    $date =$_POST["date"];
                                                    $req = "INSERT INTO tache_technicien (libelle, description, code, date) VALUES ('$nom', '$desc', '$category', '$date')"; 
