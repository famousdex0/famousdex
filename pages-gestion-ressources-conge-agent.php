...
if(isset($_POST['supp'])) {
    ...
    $query = "DELETE FROM pages_gestion_ressources_conge_agent WHERE pages_gestion_ressources_conge_agent.id ='$id' ";
...
<body>
  ...
  <aside id="sidebar" class="sidebar" data-aos="fade-right" data-aos-delay="300" data-aos-duration="400">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="pages-gestion-ressources-conge-agent.php">
  ...
  <main id="main" class="main"  data-aos-duration="600" data-aos="fade-left" data-aos-delay="500">
    ...
    <section class="tache-rapport">
        ...
        <table class="table" style="width: max-content; margin: 0 auto; " >
                <h2>Contrats</h2>
                <button class="add-button" onclick="openModal('task')" style="width:200px; height:100px ;">AJOUTER UN CONGE</button><br><br>
    ...
    <table class="table" style="width: max-content; box-shadow:1px 1px 10px black; position:absolute;  top:500px">
        <thead>
            <tr>
                ...
                <th style="color: red;">MOTIF DE CONGES</th>
        ...
        <tbody>
            <?php
                ...
                $envoi = "SELECT * FROM pages_gestion_ressources_conge_agent";
    ...
    <div class="modal" id="modal">
        <div class="modal-content">
            ...
            <form id="task-form" method="POST" style="display: none;">
                ...
                <div>
                    <label for="type_contrat" style="color:red"><strong>MOTIF DE CONGES</strong></label>
                    <input type="text" id="motif_conge" name="motif_conge" class="form-control" required>
                </div>
                <div>
