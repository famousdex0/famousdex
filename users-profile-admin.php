...
if(isset($_POST['OKK'])) {
    ...
    $requete = $connexion->prepare("INSERT INTO info_directeur (image, nom, bibliographie, compagnie, travail, pays, adresse, contact, email, twitter, facebook, instagram, linkedin) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        if (isset($_SESSION['email'])) {
            // Utilisateur connecté, afficher le nom et le prénom
            $email = $_SESSION['email'];
            $sql = "SELECT nom, prenom FROM directeur WHERE email = '$email'";
            $result = $connexion->query($sql);
  ...
  <!-- End Tables Nav -->
   ...
   <!-- End Charts Nav -->
    ...
    <!-- End Icons Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link " href="users-profile-admin.php">
          <i class="bi bi-person"></i>
          <span>Profil</span>
        </a>
...
<li class="nav-item">
  <a class="nav-link collapsed" href="pages-tache-admin.php">
    ...
    <section class="section profile">
      <div class="row">
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <?php
                        ...
                        $result = $connexion->query("SELECT image FROM info_directeur "); // Remplacez 'table_images' et 'id' par vos valeurs réelles
        ...
        if (isset($_SESSION['email'])) {
            // Utilisateur connecté, afficher le nom et le prénom
            $email = $_SESSION['email'];
            $sql = "SELECT fonction FROM directeur WHERE email = '$email'";
            $result = $connexion->query($sql);
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">
                    <?php $connexion = new mysqli("localhost", "root", "", "entreprise");
                      ...
                      $result = $connexion -> query("SELECT * FROM info_directeur");
                             if ($result->num_rows > 0) {
                                       $row = $result->fetch_assoc(); 
                  ...
                  <div class="row">
                    ...
                    $connexion = new mysqli("localhost", "root", "", "entreprise");
                      ...
                      $resulta = $connexion -> query("SELECT compagnie FROM info_directeur");
                  ...
                  <div class="row">
                    ...
                    $connexion = new mysqli("localhost", "root", "", "entreprise");
                      ...
                      $result = $connexion -> query("SELECT travail FROM info_directeur ");
                             if ($result->num_rows > 0) {
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php 
                     $result = $connexion -> query("SELECT pays FROM info_directeur ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["pays"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php
                     $result = $connexion -> query("SELECT adresse FROM info_directeur ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["adresse"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php
                     $result = $connexion -> query("SELECT contact FROM info_directeur ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["contact"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php 
                     $result = $connexion -> query("SELECT email FROM info_directeur ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["email"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php
                     $result = $connexion -> query("SELECT twitter FROM info_directeur ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["twitter"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php 
                     $result = $connexion -> query("SELECT facebook FROM info_directeur ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["facebook"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php 
                     $result = $connexion -> query("SELECT instagram FROM info_directeur ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["instagram"] ;
                                      }}  ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php 
                     $result = $connexion -> query("SELECT linkedin FROM info_directeur ");
                    if ($result->num_rows > 0) {
                                      while ($row = $result->fetch_assoc()) {
                                          echo  $row["linkedin"] ;
                                      }}  ?></div>
