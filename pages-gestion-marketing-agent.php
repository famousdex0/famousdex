...
if(isset($_POST['supp'])) {
    ...
    $query = "DELETE FROM pages_gestion_marketing_agent WHERE pages_gestion_marketing_agent.id ='$id' ";
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="pages-gestion-marketing-agent.php">
    ...
    <table class="table" style="width: max-content; box-shadow:1px 1px 10px black; position:absolute;  top:500px">
        ...
        <tbody>
            <?php
                ...
                $envoi = "SELECT * FROM pages_gestion_marketing_agent";
