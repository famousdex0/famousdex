...
if(isset($_POST['supp'])) {
    ...
    $query = "DELETE FROM tache_finance_agent WHERE tache.id ='$id' ";
    $result = $connexion->query($query);

    // Vérifiez si la suppression a réussi
    if ($result) {
        // Redirigez l'utilisateur vers une page de confirmation ou une autre page appropriée
        header("Location: pages-tache-finance-agent.php");
        exit();
    } else {
...
<head>
  ...
  <title>Pages / tache - Nicefinance-agent Bootstrap Template</title>
  ...
  <!-- =======================================================
  * Template Name: Nicefinance-agent
  * Updated: Sep 18 2023 with Bootstrap v5.3.2
  * Template URL: https://bootstrapmade.com/nice-finance-agent-bootstrap-finance-agent-php-template/
...
<body>
  ...
  <!-- ======= Sidebar ======= -->
  <aside id="sidebar" class="sidebar" data-aos="fade-right" data-aos-delay="500" data-aos-duration="400">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="users-profile-finance-agent.php">
          <i class="bi bi-person"></i>
          <span>Profil</span>
        </a>
...
<li class="nav-item">
  <a class="nav-link " href="pages-tache-finance-agent.php">
  ...
  <main id="main" class="main" data-aos-duration="600" data-aos="fade-left" data-aos-delay="500">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index-finance-agent.php">Accueil</a></li>
    ...
    <table class="table" style="width: max-content; box-shadow:1px 1px 10px black; position:absolute;  top:500px">
        ...
        <?php
                ...
                $envoi = "SELECT * FROM taches_finance_agent";
        ...
        <table class="table" style="width: max-content; margin: 0 auto;" >
              ...
              <tbody>
                ...
                $connexion = new mysqli("localhost", "root", "", "entreprise");
                /* PREPAREZ LA BASE DE DONNEES A RECHERCHER LES DONNEES */
                $envoi = "SELECT * FROM rapport_finance_agent";
                $mess = $connexion->query($envoi);
                // Affichage des résultats
                if ($mess->num_rows > 0) {
                    while ($row = $mess->fetch_assoc()) {
                         ...
                         $result = $connexion->query($sql);
                          if ($result->num_rows > 0) {
                            ...
                            $nom =$_POST["Titre"];
                                                    ...
                                                    $date =$_POST["date"];
                                                    $req = "INSERT INTO tache_finance_agent (libelle, description, code, date) VALUES ('$nom', '$desc', '$category', '$date')"; 
                        ...
                        $connexion = new mysqli("localhost", "root", "", "entreprise");
                         $result = $connexion->query($sqll);
                          if ($result->num_rows > 0) {
                            ...
                            $datee =$_POST["datee"];
                                                    $descrip =$_POST["descrip"];
                                                    $requ = "INSERT INTO rapport_finance_agent (libelle, description, code, date) VALUES ('$name', '$descrip', '$categoryy', '$datee')"; 
...
<script>
  ...
  <footer id="footer" class="footer justify-content-center" style="position:relative;  top:2000px; display:flex; align-items:center;">
    ...
    <div class="credits">
      ...
      <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/nice-finance-agent-bootstrap-finance-agent-php-template/ -->
