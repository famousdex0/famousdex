    ...
    <section class="partone" data-aos="fade-right" data-aos-delay="800" data-aos-duration="1000" >
       <div class="one"> 
          <nav class="na">
             ...
             <div class="ones"><style>.lai{ color: red; text-decoration:underline;} </style>
             <a href="gestion_journalier.php" class="lai" id="myLink"> <strong> GESTION POINTAGE JOURNALIER</strong></a>
             </div>
