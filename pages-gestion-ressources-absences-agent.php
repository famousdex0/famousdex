...
if(isset($_POST['supp'])) {
    ...
    $query = "DELETE FROM pages_gestion_ressources_absences_agent WHERE pages_gestion_ressources_absences_agent.id ='$id' ";
...
<body>
  ...
  <aside id="sidebar" class="sidebar" data-aos="fade-right" data-aos-delay="300" data-aos-duration="400">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="pages-gestion-ressources-absences-agent.php">
    ...
    <table class="table" style="width: max-content; box-shadow:1px 1px 10px black; position:absolute;  top:500px">
        <thead>
            <tr>
                ...
                <th style="color: red;">MOTIF ABSENCES</th>
        ...
        <div class="modal-content">
            ...
            <form id="task-form" method="POST" style="display: none;">
                ...
                <div>
                    ...
                    <input type="text" id="motif_absence" name="motif_absence" class="form-control" required>
                </div>
                <div>
