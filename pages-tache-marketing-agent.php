...
if(isset($_POST['supp'])) {
    ...
    $query = "DELETE FROM tache_marketing_agent WHERE tache_marketing_agent.id ='$id' ";
...
<li class="nav-item">
  <a class="nav-link collapsed" href="pages-gestion-marketing-agent.php">
    ...
    <span>Gestion des produits et la clientèle</span>
  </a>
</li>

<li class="nav-item">
  <a class="nav-link " href="pages-tache-marketing-agent.php">
    ...
    <table class="table" style="width: max-content; box-shadow:1px 1px 10px black; position:absolute;  top:500px">
        ...
        <table class="table" style="width: max-content; margin: 0 auto;" >
              ...
              <tbody>
                ...
                $connexion = new mysqli("localhost", "root", "", "entreprise");
                /* PREPAREZ LA BASE DE DONNEES A RECHERCHER LES DONNEES */
                $envoi = "SELECT * FROM rapport_marketing_agent";
                $mess = $connexion->query($envoi);
                // Affichage des résultats
                if ($mess->num_rows > 0) {
                    while ($row = $mess->fetch_assoc()) {
                         ...
                         $result = $connexion->query($sql);
                          if ($result->num_rows > 0) {
                            ...
                            $nom =$_POST["Titre"];
                                                    ...
                                                    $date =$_POST["date"];
                                                    $req = "INSERT INTO tache_marketing_agent (libelle, description, code, date) VALUES ('$nom', '$desc', '$category', '$date')"; 
